      ...
      <div className="Application-section">
        <div className="Application-section-content">
          <div className="Application-section-text Application-order-2 Application-order-md-1">
            ...
            <p>
              Mobile web apps are useful alternatives to native apps for mobile
              devices. These days, Android-based products and iOS devices like
              the iPhone and iPad all come packed with fantastic mobile browsers
              (Mobile Chrome and Mobile Safari respectively), and Opera fans can
              install their preferred browser too.
            </p>
            <p>
              From a desktop point of view, these products make browsing just
              about the most pleasurable experience possible. CSS3 transitions,
              beautifully crafted HTML5 and embellishments mean their users get
              the highest possible browsing experience (assuming the content
              being viewed has been crafted with care and consideration)..
            </p>
          </div>
      ...
      <div className="Application-section">
        <div className="Application-section-content">
          ...
          <div className="Application-section-text">
            ...
            <p>
              This course provides students with the concepts and techniques to
              design and develop software applications, and to understand the
              design process. Students will learn the importance of
        ...
        <div className="Application-section-content">
          <div className="Application-section-text Application-order-2 Application-order-md-1">
            ...
            <p>
              ...
              applications. It focuses on user-centered design and the creation
              of functional prototypes. Students learn database design, new
              programming languages, and apply MVC architecture for robust
              applications.
            </p>
          </div>
          <div className="Application-section-image Application-order-1 Application-order-md-2">
        ...
        <div className="Application-section-content">
          ...
          <div className="Application-section-text">
            ...
            <p>
              ...
              includes tools like compilers, debuggers, and emulators. Students
              learn how to develop apps using Android libraries, OpenGL, and
              more.
            </p>
          </div>
        </div>
        ...
        <div className="Application-section-content">
          <div className="Application-section-text Application-order-2 Application-order-md-1">
            ...
            <p>
              ...
              renders a web page. This is similar to translating a sentence from
              French to English — both will convey the same meaning but might
              use different words.
            </p>
          </div>
          <div className="Application-section-image Application-order-1 Application-order-md-2">
