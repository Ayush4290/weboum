...
function BackupDisasterRecovery() {
  return (
    <div className="data-backup">
      ...
      <p>
        Data is the lifeblood of every business. Readily accessible and properly
        maintained business data is crucial for every business since it dictates
        the success of modern businesses. That said, the consequences of data
        loss have never been more severe. This is where data backup and disaster
        recovery services enter the picture.
      </p>
      ...
      <div className="section">
        ...
        <div className="text-box">
          ...
          <p>
            ...
            technologies that enable us to recover lost data effortlessly. Fully
            managed data recovery solutions are offered to protect your business
            from all possible threats.
          </p>
          <p>
            Our team of data specialists perform thorough and timely backups and
            create robust safeguard processes to ensure that your irreplaceable
            data is protected.
          </p>
          <p>
      ...
      <div className="back-container">
        <div className="content">
          ...
          <p>
            We offer design, storage, monitoring, testing, failover, restoration
            assistance, reporting and much more. All your data needs are covered
            and we ensure the complete safety of your valuable data.
          </p>
          <p>
        ...
        <div className="grid">
          ...
          <div className="card">
            ...
            <div>
              ...
              <p>
                Data backups combine the entire procedure of data recovery in a
                single service. We offer design, storage, monitoring, testing,
                assistance, reporting, failover and more.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid">
          <div className="card">
            ...
            <div>
              ...
              <p>
                ...
                data recovery services deploy in minutes. We have an exact clone
                of your server in our system so that your team can start working
                again rapidly.
              </p>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div>
              ...
              <p>
                Backups by our IT team offers built-in end-to-end encryption, to
                give you the ability to encrypt data files at source.
              </p>
            </div>
          </div>
        </div>
