  ...
  return (
    <div className="page">
      ...
      <div className="section center-text">
        ...
        <p>
          Our domains have best in class security... pick biz hosting to obtain
          maximum advantages.
        </p>
        <p>
      ...
      <div className="container">
        ...
        <div className="text-section">
          <p>
            ...
            Shared hosting is an arrangement where a number of websites are kept
            on a similar server. Your will be making monthly payments to the
            hosting provider and you will share the facilities with other users
            on the server.
          </p>
          <p>
            ...
            share the physical server space with owners of other websites there.
            That said, your website will be hosted on an independent piece of
            virtual real estate. It is like renting a flat in a building with
            numerous flats. You can’t make changes to the building, but you can
            do anything you like within your rental apartment.
          </p>
          <p>
      ...
      <div className="container">
        ...
        <div className="hosting-type">
          <h4>Cloud Hosting</h4>
          <p>
            Hosted by the cloud services provider (CSP)... access to distributed
            resources...
          </p>
        </div>
      ...
      <div className="container">
        ...
        <div className="grid">
          <div className="card">
            ...
            <div>
              ...
              <p>Easily increase RAM/CPU, storage and I/O in a single click.</p>
            </div>
          </div>
        ...
        <p className="bottom-note">
          Be smart - Stay Smart – Choose web hosting services that are reliable
          and backed up. Your favorites hosting is just a click away!
        </p>
      </div>
    </div>
  );
